...
ExecStartPre=/bin/bash -c 'echo "timestamp=$$(systemctl show startup.service -p ExecMainExitTimestamp --value) event=startup result=$$(systemctl show startup.service -p Result --value) exit_code=$$(systemctl show startup.service -p ExecMainCode --value) exit_status=$$(systemctl show startup.service -p ExecMainStatus --value)" >> /home/rpdibble/rpi_cat_behaviour_monitoring/object_clips/service_stops.txt'
ExecStopPost=/bin/bash -c 'echo "timestamp=$$(systemctl show startup.service -p ExecMainExitTimestamp --value) event=stop result=$$(systemctl show startup.service -p Result --value) exit_code=$$(systemctl show startup.service -p ExecMainCode --value) exit_status=$$(systemctl show startup.service -p ExecMainStatus --value)" >> /home/rpdibble/rpi_cat_behaviour_monitoring/object_clips/service_stops.txt'
